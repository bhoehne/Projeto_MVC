...
namespace PrMVC.Data
{
    ...
    {
        private PrMVCContext _context;

        public SeedingService(PrMVCContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", 1000.0, new DateTime(1979, 12, 31), d2);
            Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", 1000.0, new DateTime(1988, 1, 15), d1);
            Seller s4 = new Seller(4, "Martha Red", "martha@gmail.com", 1000.0, new DateTime(1993, 11, 30), d4);
            Seller s5 = new Seller(5, "Donald Orange", "donald@gmail.com", 1000.0, new DateTime(2000, 1, 9), d3);
            Seller s6 = new Seller(6, "Alex Pink", "alex@gmail.com", 1000.0, new DateTime(1997, 3, 4), d2);
